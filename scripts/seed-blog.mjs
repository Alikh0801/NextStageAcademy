...
const POSTS = [
  {
    ...
    excerpt: {
      ...
      tr: 'Güçlü bir CV’nin yapısı ve en sık yapılan hatalar.',
    },
    content: {
      ...
      tr: 'CV, işverenle ilk temas noktasıdır. Net bir yapı, ölçülebilir sonuçlar ve ilana göre uyarlanmış içerik onu öne çıkarır.',
    },
  ...
  },
  {
    ...
    excerpt: {
      ...
      tr: 'Teknik bilginin yetmediği yerde iletişim ve takım çalışması devreye girer.',
    },
    content: {
      ...
      tr: 'İşverenler giderek daha fazla iletişim, takım çalışması ve uyum becerisine bakıyor. Bu beceriler öğrenilebilir ve pratikle güçlenir.',
    },
  ...
  },
  {
    ...
    title: {
      ...
      tr: 'Başarılı bir kariyer için 5 adım',
    },
    excerpt: {
      ...
      tr: 'Hedef belirlemekten ağ kurmaya kadar pratik bir yol haritası.',
    },
    content: {
      ...
      tr: 'Kariyer tesadüfen inşa edilmez. Hedef, öğrenme alışkanlığı, ağ, geri bildirim ve sabır — beş adım bunlardır.',
    },
