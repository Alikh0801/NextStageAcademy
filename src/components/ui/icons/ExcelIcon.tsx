/**
 * Microsoft Excel-in rəsmi ikonu (2019+). SVG mənbəyi: vscode-icons
 * (`file-type-excel`, MIT). Loqo Microsoft-un əmtəə nişanıdır — yalnız
 * Excel təlimini göstərmək üçün işlədirik.
 */
export function ExcelIcon({ className }: { className?: string }) {
  return (
    ...
    >
      <defs>
        {/* Səhifədə bir dəfə render olunur, ona görə sabit id kifayətdir. */}
        <linearGradient
      ...
      <path fill="url(#excel-icon-gradient)" d="M3.194 8.85h11.938a1.193 1.193 0 0 1 1.194 1.191v11.918a1.193 1.193 0 0 1-1.194 1.191H3.194A1.19 1.19 0 0 1 2 21.959V10.041A1.19 1.19 0 0 1 3.194 8.85" />
